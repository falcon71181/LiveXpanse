    ...
    <main className="px-5 bg-[#151E27] fixed h-12 w-full flex items-center justify-between border-2 border-blue-500">
      ...
      <section className="flex items-center justify-center h-8">
        <input
          type="text"
          name="text"
          className="input text-[#f7f7f8] mr-[1px] px-[7px] py-[10px] outline-none w-64 h-full bg-[#151E27] transition-all duration-200 ease rounded-l border-[1px] border-white focus:border-[2px] focus:border-[#a970ff] focus:bg-[#0e0e10]"
          placeholder="Search"
        ></input>
